...
internal class Sprite
{
    ...
    public Sprite(int x, int y, Texture2D image, Rectangle? sourceRectangle = null)
    {
    ...
    public void ApplyGravity(GameTime gameTime)
    {
        ...
        // Update the position based on the vertical vejlocity and the elapsed time
        position.Y += verticalVelocity * (float)gameTime.ElapsedGameTime.TotalSeconds;
    ...
    public bool Collision(Sprite s)
    {
        ...
        Rectangle r1 = new Rectangle((int)position.X, (int)position.Y, sourceRectangle.Width, sourceRectangle.Height);
        Rectangle r2 = new Rectangle((int)s.position.X, (int)s.position.Y, s.sourceRectangle.Width, s.sourceRectangle.Height);
