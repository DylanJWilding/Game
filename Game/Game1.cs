...
namespace GameHND
{
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            enemyArray[0] = new Sprite(500, 132, Content.Load<Texture2D>("trashman"), trashmanSource);

            Rectangle nightmanSource = new Rectangle(64, 0, 32, 32); // Set the area of the sprite sheet to display for nightman
            enemyArray[1] = new Sprite(450, 32, Content.Load<Texture2D>("nightman"), nightmanSource);
